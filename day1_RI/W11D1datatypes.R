...
d <- 2.5
# poniendo L lo estas haciendo tipo entero
# los numeros por defecto se asignan a tipo doble
e <- 5L
f <- as.complex(-1)
...
is.numeric(d) #son n??mericos tanto los doubles como los integers
...
# seleccionar la primera y la ??ltima pelicula
...
otro_vector <- c(1,2,5,"hola") # Convierte los numeros a strings para que sea compatible
...
# crear matriz 
ventas <- c(460.998, 314.4, 290.475, 247.900, 309.306, 165.8, 565.89, 78.98, 344.3, 590.99, 100.00, 345.67, 321.4, 890.99, 33.33, 789.12, 678.345, 372.45)
...
# Devuelve TRUE en los valores que no son NAN
